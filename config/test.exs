...
# Set explicitly because config.exs has no default and an unset bucket makes DocumentUploader
# reject every upload. All S3 calls are mocked, so the name only has to be present, not real.
