defmodule CadetWeb.UserControllerTest do
  ...
  describe "GET /v2/courses/{course_id}/user/total_xp" do
    @tag authenticate: :student, group: true
    test "achivement (is_variable_xp: false), one completed goal", %{
      conn: conn
    } do
    ...
    @tag authenticate: :student, group: true
    test "achivement (is_variable_xp: true), no goals.", %{
      conn: conn
    } do
      test_cr = conn.assigns.test_cr
      course = conn.assigns.test_cr.course
    ...
    @tag authenticate: :student, group: true
    test "achivement (is_variable_xp: true), one incomplete goal (no progress entry).", %{
      conn: conn
    } do
      test_cr = conn.assigns.test_cr
      course = conn.assigns.test_cr.course
    ...
    @tag authenticate: :student, group: true
    test "achivement (is_variable_xp: true), one incomplete goal (with progress entry).", %{
      conn: conn
    } do
      test_cr = conn.assigns.test_cr
      course = conn.assigns.test_cr.course
    ...
    @tag authenticate: :student, group: true
    test "achivement (is_variable_xp: true), one goal completed.", %{
      conn: conn
    } do
      test_cr = conn.assigns.test_cr
      course = conn.assigns.test_cr.course
    ...
    @tag authenticate: :student, group: true
    test "achivement (is_variable_xp: true), with one goal completed and one goal incomplete", %{
      conn: conn
    } do
      test_cr = conn.assigns.test_cr
      course = conn.assigns.test_cr.course
    ...
    @tag authenticate: :student, group: true
    test "achivement (is_variable_xp: true), one goal with 0 target_count and 0 count", %{
      conn: conn
    } do
      test_cr = conn.assigns.test_cr
      course = conn.assigns.test_cr.course
