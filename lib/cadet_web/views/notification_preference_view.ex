defmodule CadetWeb.NotificationPreferenceView do
  ...
  def render("index.json", %{notification_preferences: notification_preferences}) do
    %{data: render_many(notification_preferences, NotificationPreferenceView, "notification_preference.json")}
  end

  def render("show.json", %{notification_preference: notification_preference}) do
    %{data: render_one(notification_preference, NotificationPreferenceView, "notification_preference.json")}
  end
