...
yystate(9, [C|Ics], Line, Tlen, Action, Alen) when C >= 11, C =< 41 ->
    yystate(9, Ics, Line, Tlen+1, Action, Alen);
yystate(9, [C|Ics], Line, Tlen, Action, Alen) when C >= 43 ->
    yystate(9, Ics, Line, Tlen+1, Action, Alen);
...
yystate(8, [C|Ics], Line, Tlen, _, _) when C >= 14, C =< 31 ->
    yystate(12, Ics, Line, Tlen+1, 4, Tlen);
yystate(8, [C|Ics], Line, Tlen, _, _) when C >= 34, C =< 36 ->
    yystate(12, Ics, Line, Tlen+1, 4, Tlen);
yystate(8, [C|Ics], Line, Tlen, _, _) when C >= 48, C =< 57 ->
    yystate(1, Ics, Line, Tlen+1, 4, Tlen);
yystate(8, [C|Ics], Line, Tlen, _, _) when C >= 65, C =< 90 ->
    yystate(1, Ics, Line, Tlen+1, 4, Tlen);
yystate(8, [C|Ics], Line, Tlen, _, _) when C >= 91, C =< 93 ->
    yystate(12, Ics, Line, Tlen+1, 4, Tlen);
...
yystate(5, [C|Ics], Line, Tlen, Action, Alen) when C >= 0, C =< 9 ->
    yystate(9, Ics, Line, Tlen+1, Action, Alen);
yystate(5, [C|Ics], Line, Tlen, Action, Alen) when C >= 11, C =< 41 ->
    yystate(9, Ics, Line, Tlen+1, Action, Alen);
...
-file("src/source_lexer.xrl", 9).
yyaction_0() ->
     skip_token .

-compile({inline,yyaction_1/0}).
-file("src/source_lexer.xrl", 10).
yyaction_1() ->
     skip_token .

-compile({inline,yyaction_2/0}).
-file("src/source_lexer.xrl", 11).
yyaction_2() ->
     skip_token .

-compile({inline,yyaction_3/2}).
-file("src/source_lexer.xrl", 12).
yyaction_3(TokenChars, TokenLine) ->
     { token, { list_to_atom (TokenChars), TokenLine } } .

-compile({inline,yyaction_4/2}).
-file("src/source_lexer.xrl", 13).
yyaction_4(TokenChars, TokenLine) ->
     { token, { list_to_atom (TokenChars), TokenLine } } .

-compile({inline,yyaction_5/0}).
-file("src/source_lexer.xrl", 14).
yyaction_5() ->
     skip_token .
